  ...
  <el-container style="height: 100%">
    ...
    <el-dialog title="添加连接器"  :close-on-click-modal="false"   width="80%" style="height: auto" :visible.sync="dialogFormVisibleAdd">
      ...
      <div style="text-align: center">
        <el-button type="primary" @click="submitFormAdd('conFormAdd','mqttFormAdd','rpcFormAdd')">提交</el-button>
        <el-button @click="resetAdd('conFormAdd','mqttFormAdd','rpcFormAdd')">重置</el-button>
      </div>
    </el-dialog>
    ...
    <el-dialog title="编辑mqtt"  :before-close="handleClose"  :close-on-click-modal="false" :modal-append-to-body = "false" :close-on-press-escape="false" width="70%" style="height: auto" :visible.sync="dialogFormVisibleEdit">
      <el-tabs v-model="activeName" type="card">
        <el-tab-pane label="连接器" name="first"><el-row :gutter="20">
          <el-col :span="12"><div class="grid-content bg-purple">
            ...
            Connector
            <el-form :model="conFormEdit" style="margin-left: 31%" :rules="conRuleEdit" ref="conFormEdit" size="mini" label-width="130px" class="demo-ruleForm">
              <el-form-item label="连接器名称：" prop="name">
                <el-input disabled v-model="conFormEdit.name" style="width: auto"></el-input>
              </el-form-item>
              <el-form-item label="协议：" prop="protocolType">
        ...
        <el-tab-pane label="MQTT" name="second"><el-row :gutter="20">
          <el-col :span="12"><div class="grid-content bg-purple">
            ...
            Mqtt Broker
            <el-form :model="mqttFormEdit" style="margin-left: 32%" :rules="mqttRule" ref="mqttFormEdit" size="mini"  label-width="130px" class="demo-ruleForm">
              <el-form-item label="名称：" prop="name">
        ...
        <el-tab-pane label="服务端RPC" name="fifth"><el-col :span="12"><div class="grid-content bg-purple"></div>
          服务端RPC
          <el-form :model="rpcFormEdit" style="margin-left: 32%"  ref="rpcFormEdit" size="mini" label-width="130px" class="demo-ruleForm">
            <el-form-item label="设备名过滤：" prop="deviceNameGl">
      ...
      <div style="text-align:center;margin-left: -25%">
        <el-button type="primary" @click="submitFormEdit('conFormEdit','mqttFormEdit')">提交</el-button>
        <el-button @click="cancle()">取消</el-button>
      </div>
    </el-dialog>
...
export default {
  ...
  methods: {
    ...
    submitFormAdd(conFormAdd,mqttFormAdd,rpcFormAdd) {
...
// 判断是否为json格式
    ...
    submitFormEdit(conFormEdit,mqttFormEdit){
      this.$refs[conFormEdit].validate((valid) => {
        if(valid){
          this.$refs[mqttFormEdit].validate((valid) => {
            if(valid){
                                  this.$confirm('确定编辑吗?', '提示', {
                                    ...
                                    json.serverSideRpc[0].deviceNameFilter = this.rpcFormEdit.deviceNameGl;
                                    json.serverSideRpc[0].methodFilter = this.rpcFormEdit.methodGl
                                    json.serverSideRpc[0].requestTopicExpression = this.rpcFormEdit.requestTopic
                                    json.serverSideRpc[0].responseTopicExpression = this.rpcFormEdit.responseTopic
                                    json.serverSideRpc[0].responseTimeout = this.rpcFormEdit.responseCs
                                    json.serverSideRpc[0].valueExpression = this.rpcFormEdit.returnExp
                                    con.json = json;
                                    updateConByName(con).then(res=> {
