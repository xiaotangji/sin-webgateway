  ...
  <div style="height: 80%">
    <el-row class="basicCan">
      ...
      <el-col :span="12"><div class="grid-content bg-purple"></div>
        <el-form size="mini" :model="ruleFormJson" :label-position="labelPosition" :rules="rulesJson" ref="ruleFormJson" label-width="100px" class="demo-ruleForm">
          <el-form-item label="name:" style="width: 80%" prop="name">
            <el-input
            placeholder="请输入"
          ...
          <el-form-item label="type:"  style="width: 80%" prop="type">
            <el-input
            placeholder="请输入"
            style="margin-left: 35%;width: 50%;"
          ...
          <el-form-item label="port:" style="width: 80%" prop="port">
            <el-input
              placeholder="请输入"
              style="margin-left: 35%;width: 50%;"
              v-model="ruleFormJson.port">
            </el-input>
          </el-form-item>
          <el-form-item label="baudrate:"  style="width: 80%" prop="baudrate">
            <el-input
              placeholder="请输入"
              style="margin-left: 35%;width: 50%;"
              v-model="ruleFormJson.baudrate">
            </el-input>
          </el-form-item>
          <el-form-item label="converter:" style="width: 80%" prop="converter">
            <el-input
              placeholder="请输入"
              style="margin-left: 35%;width: 50%;"
              v-model="ruleFormJson.converter">
            </el-input>
          </el-form-item>
          <el-form-item style="margin-left: -11%">
            <el-button style="margin-left: 39%;" type="primary" @click="submitFormSaveJson('ruleFormJson')">保存</el-button>
      ...
      <el-col :span="12"><div class="grid-content bg-purple"></div>
        <el-form :model="ruleFormUpdateJson" :rules="rulesUpdateJson" ref="ruleFormUpdate" label-width="100px" class="demo-ruleForm">
          ...
          <el-button style="margin-left: 25%;margin-top: 3%" type="primary" @click="submitFormSave('ruleFormUpdate')">保存</el-button>
          <el-button style="margin-left: 8%;margin-top: 10px" @click="resetForm('ruleFormUpdate')">重置</el-button>
        </el-form>
      </el-col>
    </el-row>
  ...
  data() {
    return {
      ...
      rulesJson: {
        ...
        converter: [
          { required: true, message: '请输入converter', trigger: 'blur' },
          { min: 2, max:100,message: '长度在 2 到 100 个字符',trigger: 'blur' }
        ]
      },
      serialRulesAdd: {
